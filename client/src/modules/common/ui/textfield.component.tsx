  ...
  ({ label, error, leftAddon, rightAddon, className, ...inputProps }, ref) => {
    ...
    return (
      <div className={classes}>
        ...
        <label className="px-3 py-2 flex items-center gap-3 bg-labelFill border-1 border-textFieldBorder rounded text-xl cursor-text dark:bg-dark-200 dark:border-dark-300 dark:text-secondary-50">
          {leftAddon}
          <input
